...
## Request too large for text-embedding
## Limit 1000000, Requested 1459641
...
#         chunks.extend(list(read_file_in_chunks(file_path)))

book_names = ["cleaned_GOT.txt", "cleaned_COK.txt"]  # Replace with the names of your books
directory = "./sif_txt/"
chunks = []
...
def main():
    ...
    log_number = 1
    logs_directory = "./logs"
    while os.path.exists(f"{logs_directory}/response_log_{log_number}.txt"):
        log_number += 1
    
    # Open the log file in append mode
    log_file = open(f"{logs_directory}/response_log_{log_number}.txt", "a")
